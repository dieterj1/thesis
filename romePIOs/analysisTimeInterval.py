...
def create_popup_content(cluster):
    ...
    content = [
        ...
        f"<b>GPS Points:</b> {cluster['total_points']}",
        "<hr>"
    ]
...
def main():
    ...
    for cluster in tqdm(cluster_data, desc="Adding markers"):
        popup_content = create_popup_content(cluster)
    ...
    map_rome.save('taxi_stopsTIMEmin50samples.html')
    print("Map saved to taxi_stopsTIMEmin50samples.html")
